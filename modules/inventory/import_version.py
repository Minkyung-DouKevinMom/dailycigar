        ...
        if batch_df.empty:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "total_individual_tax_krw": st.column_config.NumberColumn("개별소비세(KRW)", format="₩%,.0f"),
                    "total_tobacco_tax_krw": st.column_config.NumberColumn("담배소비세(KRW)", format="₩%,.0f"),
                    "total_local_education_tax_krw": st.column_config.NumberColumn("지방교육세(KRW)", format="₩%,.0f"),
                    "total_health_charge_krw": st.column_config.NumberColumn("건강증진부담금(KRW)", format="₩%,.0f"),
                    "total_import_vat_krw": st.column_config.NumberColumn("수입부가세(KRW)", format="₩%,.0f"),
                    "notes": "비고",
                    "created_at": "생성일",
                }
            )
